    ...
    services: [
      {
        ...
        description: 'Temporary Residence Card via investment, work permit, or marriage. 6 months to 4 years validity.',
        features: ['Investment TRC: 6 months - 4 years', 'Work permit-based TRC: 2 years', 'Marriage TRC: up to 3 years', '2-3 weeks processing'],
        duration: '2-3 weeks',
        badge: 'Most Popular',
        icon: (
